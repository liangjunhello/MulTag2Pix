...
class tag2pix(object):
    def __init__(self, args):
        ...
        elif args.model == 'convnet_dev_adain1_skeleton':
            from convnet_dev_adain1_skeleton import Generator
...
# results/230822-235257
            print("convnet_dev_skeleton_Adain(不修改损失函数)的测试") 
            loadurl=self.result_path /'230822-235257'/ 'tag2pix_{}_epoch.pkl'.format(epoche)
            result_path = self.result_path /'convnet_dev_skeleton_Adain_noloss_result'/ 'tag2pix_{}_epoch'.format(epoche)
